...
EPKI 연계 API는 교육부 산하 기관, 전국 시도 교육청, 학교 등 교육·연구기관 종사자들이 민간 SaaS에 로그인 시, <br/>
...
```text
GET https://saas.go.kr/epki/oauth2/authorize?
    client_id=${연계서비스ID}&
...
```text
GET https://saas.go.kr/epki/connect/logout?
